...
module instruction_memory import riscv_pkg::*; (
    ...
    assign inst[5] = 32'h00502023; // sw x5, 0(x0)
    assign inst[6] = 32'h00228293; // addi x5, x5, 2
    assign inst[7] = 32'h005020a3; // sw x5, 1(x0)
    assign inst[8] = 32'h00002203; // lw x4, 0(x0)
    assign inst[9] = 32'h00102183; // lw x3, 1(x0)
